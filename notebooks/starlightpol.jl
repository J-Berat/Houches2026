...
> **Lazy startup.** Run `run_pluto.jl`, then select `starlightpol.jl`. Pluto starts without evaluating the expensive cells; run the result cells you need and Pluto will resolve their upstream dependencies.
