...
const NOTEBOOK_SPECS = [
    (
        ...
        figures = [
            ...
            ("density_spectra_time", "Number-density power spectra through time", :fig_density_spectra_time),
            ("velocity_spectra_time", "Turbulent-velocity power spectra through time", :fig_velocity_spectra_time),
            ("vorticity_spectra_time", "Vorticity power spectra through time", :fig_vorticity_spectra_time),
            ("enstrophy_spectra_time", "Enstrophy spectra through time", :fig_enstrophy_spectra_time),
